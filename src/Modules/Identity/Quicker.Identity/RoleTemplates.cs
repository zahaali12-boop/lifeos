...
public static class RoleTemplates
{
    ...
    [
        ...
        new("purchaser", LocalizedText.Bilingual("Purchaser", "مسؤول مشتريات"), "Requisitions, RFQs, purchase orders and suppliers",
            ["purchasing.requisition.*", "purchasing.rfq.*", "purchasing.agreement.*", "purchasing.order.*", "purchasing.receipt.*", "purchasing.return.*", "purchasing.landed_cost.*", "partners.supplier.*", "partners.terms.manage", "inventory.item.read", "inventory.warehouse.read"]),
