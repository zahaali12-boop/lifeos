...
public static class RoleTemplates
{
    ...
    [
        ...
        new("sales_manager", LocalizedText.Bilingual("Sales manager", "مدير المبيعات"), "Sales team, commission plans, pipeline stages, customer groups and every sales document",
            ["sales.*", "partners.customer.*", "partners.sales_setup.manage", "partners.terms.manage", "inventory.item.read", "reporting.*"]),
