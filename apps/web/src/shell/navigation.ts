...
export const navigation: NavigationItem[] = [
  ...
  { to: "/purchasing/intelligence", label: "nav.supplierIntelligence", icon: Gauge, shortcut: "g ]", permission: "purchasing.intelligence.read" },
